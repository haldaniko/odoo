...
const PROJECT_TITLE = "Проект BG16RFPR001-1.012-0120-C01";
const PROJECT_IMAGE = "/web/static/src/webclient/license_project_systray/project-hashtaghub.jpg";
const LICENSE_ROWS = [
    ["РАЗРАБОТЧИК", "Ай-Ти Степ ООД"],
    ["CRM система", "CRM Base 02.11"],
    ["ЛИЦЕНЗ", "02-011-0125"],
    ["ЛИЦЕНЗОПОЛУЧАТЕЛ", "Хаштаг ЕООД"],
    ["Финансирано на проект", "BG16RFPR001-1.012-0120-C01"],
];
